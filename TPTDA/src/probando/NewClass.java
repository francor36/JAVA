...
public class NewClass {
    ...
    public static void main(String[] args) {
        ...
        //Llena la fila superior de izquierda a derecha â†’
        for(i=inicio; i<=fin; i++){
            matriz[inicio][i]= valor++ + " \t";
        }
        
         //Llena la columna del extremo derecho de arriba hacai abajo â†“
        for(i=inicio+1; i<=fin; i++){
            matriz[i][fin]= valor++ + " \t";
        }
        
         //Llena la fila Inferior de derecha a izquierda â†�
        for(i=fin-1; i>=inicio; i--){
            matriz[fin][i]= valor++ + " \t";
        }
        
         //Llena la columna del extremo izquierdo de abajo hacia arribaâ†‘
